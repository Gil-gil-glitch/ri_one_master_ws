#
##  Home Task Person Targetting Node
#
#   This node subscribes to the RealSense camera feed and detects people using a YOLOv8 segmentation model. 
#   When the user gives the "thumbsup" gesture command, it locks onto the most centered person in view 
#   and publishes their (x, y, depth) coordinates to the /target_person topic. It continuously tracks 
#   the target person, updating their position and handling occlusions gracefully. The node also provides
#   debug logging and visualizations to assist with development and testing.
#
